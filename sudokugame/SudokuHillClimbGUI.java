...
public class SudokuHillClimbGUI extends JFrame {
	...
	static int[][] sample = { { 5, 3, 0, 0, 7, 0, 0, 0, 0 }, { 6, 0, 0, 1, 9, 5, 0, 0, 0 },
		...
		for (int r = 0; r < 9; r++)
			for (int c = 0; c < 9; c++) {
				...
				if (!board.cells[r][c].fixed)
					fields[r][c].setBackground(new Color(200, 255, 200));
			}
		JOptionPane.showMessageDialog(this,
				solved ? "Solved!" : "Not fully solved. Conflicts=" + board.computeConflicts());
	}
